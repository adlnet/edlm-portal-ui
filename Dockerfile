...
ARG NEXT_PUBLIC_XAPI_LRS_KEY
ARG NEXT_PUBLIC_XAPI_LRS_SECRET

ENV NEXT_PUBLIC_XAPI_LRS_KEY=$NEXT_PUBLIC_XAPI_LRS_KEY
ENV NEXT_PUBLIC_XAPI_LRS_SECRET=$NEXT_PUBLIC_XAPI_LRS_SECRET
