              ...
              <div className='' >
                ...
                <Sidebar.Items>
                  <Sidebar.ItemGroup>
                    ...
                    <Sidebar.Item href="/talentManager" className='m-1 py-2 pl-1'>
                        <div className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
                    ...
                    <Sidebar.Item href="/talentManager/talentFinder" className='m-1 py-2 pl-1'>
                        <div className="flex flex-row">
                    ...
                    <Sidebar.Item href="/talentManager/trainingPlan" className='m-1 py-2 pl-1'>
                        <div className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
                    ...
                    <Sidebar.Item href="/talentManager/help" className='m-1 py-2 pl-1'>
                        <div className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
