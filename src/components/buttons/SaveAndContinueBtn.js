...
export default function SaveAndContinueBtn ({ onClick, disabled }) {
  // Accessibility
  ...
  return (
    ...
    >
      <div className="pt-2 pb-[7px] px-3 bg-[#00509F] overflow-hidden rounded-lg outline outline-1 outline-[#135F9B] outline-offset-[-1px] justify-center items-center gap-2 flex">
        <div className="text-center justify-center flex flex-col text-white text-base font-medium font-['Roboto'] leading-[22.4px]">
          Save & Continue
        </div>
      </div>
    </button>
