                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-4 py-3">Work Role</th>
                            <th scope="col" className="px-4 py-3">Service</th>
                            <th scope="col" className="px-4 py-3">Job Posting ID</th>
                            <th scope="col" className="px-1 py-3">Workforce Element</th>
                            <th scope="col" className="px-1 py-3">Functional Community</th>
                        ...
                        {data?.map((data) => {
                            return (
                                <tr className="border-b dark:border-gray-700">
                                    ...
                                    <td className="px-4 py-3">{data.JobPostingID}</td>
                                    <td className="px-4 py-3">{data.DepartmentName}</td>
                                    <td className="px-4 py-3">Cyber</td>
                                </tr>
                            )
                        })}
