...
function validateUserPwd (userPwd, setPasswordError, setError) {
  ...
  else if (!isLongEnough(userPwd, 8)) {
    return unstable_batchedUpdates(() => {
      setPasswordError(true);
  ...
  else if (!containsLowercase(userPwd)) {
    return unstable_batchedUpdates(() => {
      setPasswordError(true);
  ...
  else if (!containsUppercase(userPwd)) {
    return unstable_batchedUpdates(() => {
      setPasswordError(true);
  ...
  else if (!containsSpecialCharacter(userPwd)) {
    return unstable_batchedUpdates(() => {
      setPasswordError(true);
  ...
  else if (!containsNumber(userPwd)) {
    return unstable_batchedUpdates(() => {
      setPasswordError(true);
...
function validateConfirmPwd (confirmPwd, userPwd, setConfPasswordError, setError) {
...
export default function Register() {
  ...
  useEffect(() => {
    validateUserPwd(credentials.userPwd, setPasswordError, setError);
  }, [credentials.userPwd]);

  useEffect(() => {
    validateConfirmPwd(credentials.confirmPwd, credentials.userPwd, setConfPasswordError, setError);
  }, [credentials.confirmPwd, credentials.userPwd]);
